...
_i1.GetIt testInitGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i47.GetCurrentUser>(
      () => _i47.GetCurrentUser(get<_i19.IUserRepository>()),
  ...
  gh.lazySingleton<_i49.GetMostRecentTechniques>(
      () => _i49.GetMostRecentTechniques(get<_i15.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i50.GetTechniques>(
      () => _i50.GetTechniques(get<_i15.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i51.GetTechniquesByCategory>(
      () => _i51.GetTechniquesByCategory(get<_i15.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i52.GetVisibleCategories>(
      () => _i52.GetVisibleCategories(get<_i9.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  ...
  gh.factory<_i54.HiddenCategoriesBloc>(
      () => _i54.HiddenCategoriesBloc(get<_i48.GetHiddenCategories>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i55.NewTechniquesBloc>(
      () => _i55.NewTechniquesBloc(get<_i49.GetMostRecentTechniques>()),
      registerFor: {_prod, _dev});
  ...
  gh.factory<_i58.TechniquesBloc>(
      () => _i58.TechniquesBloc(
          get<_i51.GetTechniquesByCategory>(), get<_i50.GetTechniques>()),
      registerFor: {_prod, _dev});
  ...
  gh.factory<_i60.VisibleCategoriesBloc>(
      () => _i60.VisibleCategoriesBloc(get<_i52.GetVisibleCategories>()),
      registerFor: {_prod, _dev});
  ...
  gh.factory<_i63.CategoryDetailBloc>(
      () => _i63.CategoryDetailBloc(get<_i51.GetTechniquesByCategory>()),
      registerFor: {_prod, _dev});
