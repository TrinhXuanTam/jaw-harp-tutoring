...
_i1.GetIt testInitGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i18.SetLocale>(
      () => _i18.SetLocale(get<_i9.IUserFacade>(), get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev});
  ...
  gh.factory<_i26.EmailVerificationBloc>(
      () => _i26.EmailVerificationBloc(get<_i19.SignOut>(),
          get<_i17.SendEmailVerification>(), get<_i25.EmailIsVerified>()),
      registerFor: {_prod, _dev});
  ...
  gh.lazySingleton<_i29.GetCurrentUser>(
      () => _i29.GetCurrentUser(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _get_current_user_test_env});
  gh.lazySingleton<_i30.GetHiddenCategories>(
      () => _i30.GetHiddenCategories(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i31.GetVisibleCategories>(
      () => _i31.GetVisibleCategories(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i32.GoogleAuthentication>(
      () => _i32.GoogleAuthentication(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _google_authentication_test_env});
  gh.factory<_i33.SignUpBloc>(
      () => _i33.SignUpBloc(get<_i20.SignUp>(), get<_i28.GetAuthProviders>(),
          get<_i13.LinkEmailProvider>()),
      registerFor: {_prod, _dev});
  gh.factory<_i34.ThirdPartyAuthBloc>(
      () => _i34.ThirdPartyAuthBloc(
          get<_i27.FacebookAuthentication>(),
          get<_i32.GoogleAuthentication>(),
          get<_i28.GetAuthProviders>(),
          get<_i14.LinkFacebookProvider>()),
      registerFor: {_prod, _dev});
  gh.factory<_i35.AdminMenuBloc>(
      () => _i35.AdminMenuBloc(
          get<_i31.GetVisibleCategories>(), get<_i30.GetHiddenCategories>()),
      registerFor: {_prod, _dev});
  gh.factory<_i36.AuthBloc>(
      () => _i36.AuthBloc(
          get<_i29.GetCurrentUser>(),
          get<_i25.EmailIsVerified>(),
          get<_i18.SetLocale>(),
          get<_i19.SignOut>()),
      registerFor: {_prod, _dev});
  gh.factory<_i37.EmailAuthBloc>(
      () => _i37.EmailAuthBloc(get<_i24.EmailAuthentication>()),
      registerFor: {_prod, _dev});
  return get;
}
