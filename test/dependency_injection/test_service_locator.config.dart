...
_i1.GetIt testInitGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i14.ITechniqueAdminRepository>(
      ...
      registerFor: {_prod});
  gh.lazySingleton<_i16.IUserFacade>(() => _i7.IUserFacadeMock(), registerFor: {
  ...
  gh.lazySingleton<_i16.IUserFacade>(() => _i17.FirebaseAuthFacade(),
      registerFor: {_prod});
  gh.lazySingleton<_i18.IUserRepository>(() => _i7.IUserRepositoryMock(),
      registerFor: {
        _email_authentication_test_env,
        _get_current_user_test_env,
        _sign_up_test_env,
  ...
  gh.lazySingleton<_i18.IUserRepository>(
      () => _i19.UserRepository(get<_i6.FirebaseAuthDataSource>()),
