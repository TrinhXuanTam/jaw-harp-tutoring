...
_i1.GetIt testInitGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i28.CreateTechnique>(
      () => _i28.CreateTechnique(get<_i8.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  ...
  gh.lazySingleton<_i31.FacebookAuthentication>(
      () => _i31.FacebookAuthentication(get<_i12.IUserRepository>()),
      registerFor: {_prod, _dev, _facebook_authentication_test_env});
  gh.lazySingleton<_i32.GetAllCategories>(
      () => _i32.GetAllCategories(get<_i8.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  ...
  gh.lazySingleton<_i36.GetTechniquesByCategory>(
      () => _i36.GetTechniquesByCategory(get<_i8.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i37.GetVisibleCategories>(
      () => _i37.GetVisibleCategories(get<_i8.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i38.GoogleAuthentication>(
      () => _i38.GoogleAuthentication(get<_i12.IUserRepository>()),
  ...
  gh.factoryParam<_i43.CategoryFormBloc, _i43.CategoryFormState?, dynamic>(
      (initialState, _) =>
          _i43.CategoryFormBloc(initialState, get<_i27.CreateCategory>()),
      registerFor: {_prod, _dev});
