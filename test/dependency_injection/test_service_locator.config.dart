...
_i1.GetIt testInitGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i31.PickVideo>(() => _i31.PickVideo(),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i32.ReloadUser>(
  ...
  gh.lazySingleton<_i35.SetLocale>(
      () => _i35.SetLocale(
          get<_i21.IUserFacade>(), get<_i19.IUserAuthRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i36.SignOut>(() => _i36.SignOut(get<_i21.IUserFacade>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i37.SignUp>(
      () => _i37.SignUp(get<_i19.IUserAuthRepository>()),
      registerFor: {_prod, _dev, _sign_up_test_env});
  gh.factory<_i38.TechniqueDetailBloc>(
      () => _i38.TechniqueDetailBloc(get<_i27.MarkTechniqueAsFavorite>(),
          get<_i33.RemoveTechniqueFromFavorites>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i39.TechniqueLocalDataSource>(
      () => _i39.TechniqueLocalDataSource(),
      registerFor: {_prod});
  gh.factory<_i40.ThumbnailPickerBloc>(
      () => _i40.ThumbnailPickerBloc(get<_i30.PickImage>()),
      registerFor: {_prod, _dev});
  gh.factory<_i41.ToggleSwitchBloc>(() => _i41.ToggleSwitchBloc(),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i42.UpdateCategory>(
      () => _i42.UpdateCategory(get<_i11.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i43.UpdateTechnique>(
      () => _i43.UpdateTechnique(get<_i17.ITechniqueAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.factory<_i44.UserSectionNavigationBloc>(
      () => _i44.UserSectionNavigationBloc(),
      registerFor: {_prod, _dev});
  gh.factory<_i45.VideoPickerBloc>(
      () => _i45.VideoPickerBloc(get<_i31.PickVideo>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i46.CreateCategory>(
      () => _i46.CreateCategory(get<_i11.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i47.CreateTechnique>(
      () => _i47.CreateTechnique(get<_i17.ITechniqueAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i48.EmailAuthentication>(
      () => _i48.EmailAuthentication(get<_i19.IUserAuthRepository>()),
  ...
  gh.lazySingleton<_i61.ITechniqueRepository>(
      () => _i62.TechniqueRepository(get<_i9.FirebaseUserSectionDataSource>(),
          get<_i39.TechniqueLocalDataSource>()),
      registerFor: {_prod});
  gh.factoryParam<_i63.TechniqueFormBloc, _i63.TechniqueFormState?, dynamic>(
      (initialState, _) => _i63.TechniqueFormBloc(
          ...
          get<_i47.CreateTechnique>(),
          get<_i43.UpdateTechnique>(),
          get<_i4.ErrorBloc>()),
      registerFor: {_prod, _dev});
  ...
  gh.factory<_i66.VisibleCategoriesBloc>(
      () => _i66.VisibleCategoriesBloc(get<_i58.GetVisibleCategories>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i67.AuthBloc>(
      () => _i67.AuthBloc(get<_i55.GetCurrentUser>(), get<_i36.SignOut>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i68.CategoriesBloc>(
      () => _i68.CategoriesBloc(get<_i53.GetCategories>()),
      registerFor: {_prod, _dev});
  gh.factoryParam<_i69.CategoryFormBloc, _i69.CategoryFormState?, dynamic>(
      (initialState, _) => _i69.CategoryFormBloc(
          initialState, get<_i46.CreateCategory>(), get<_i42.UpdateCategory>()),
      registerFor: {_prod, _dev});
  gh.factory<_i70.CategoryLocalizationBloc>(
      () => _i70.CategoryLocalizationBloc(get<_i54.GetCategoryLocalizedData>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i71.DeleteDownloadedTechnique>(
      () => _i71.DeleteDownloadedTechnique(get<_i61.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i72.DownloadTechnique>(
      () => _i72.DownloadTechnique(get<_i61.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.factory<_i73.EmailFormBloc>(() => _i73.EmailFormBloc(
      get<_i48.EmailAuthentication>(),
      get<_i4.ErrorBloc>(),
      get<_i67.AuthBloc>()));
  gh.factory<_i74.EmailVerificationBloc>(
      () => _i74.EmailVerificationBloc(
          get<_i36.SignOut>(),
          get<_i34.SendEmailVerification>(),
          get<_i32.ReloadUser>(),
          get<_i4.ErrorBloc>(),
          get<_i67.AuthBloc>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i75.GetDownloadedTechniques>(
      () => _i75.GetDownloadedTechniques(get<_i61.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i76.GetMostRecentTechniques>(
      () => _i76.GetMostRecentTechniques(get<_i61.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i77.GetTechniqueById>(
      () => _i77.GetTechniqueById(get<_i61.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i78.GetTechniques>(
      () => _i78.GetTechniques(get<_i61.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i79.GetTechniquesByCategory>(
      () => _i79.GetTechniquesByCategory(get<_i61.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  ...
  gh.factory<_i82.SignUpBloc>(
      () => _i82.SignUpBloc(get<_i37.SignUp>(), get<_i52.GetAuthProviders>(),
          get<_i4.ErrorBloc>(), get<_i67.AuthBloc>()),
      registerFor: {_prod, _dev});
  gh.factory<_i83.SplashScreenBloc>(
      () => _i83.SplashScreenBloc(get<_i55.GetCurrentUser>(),
          get<_i35.SetLocale>(), get<_i67.AuthBloc>()),
      registerFor: {_prod, _dev});
