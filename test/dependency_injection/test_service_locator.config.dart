...
_i1.GetIt testInitGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i48.GetCurrentUser>(
      () => _i48.GetCurrentUser(get<_i20.IUserRepository>()),
  ...
  gh.lazySingleton<_i50.GetMostRecentTechniques>(
      () => _i50.GetMostRecentTechniques(get<_i16.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i51.GetTechniques>(
      () => _i51.GetTechniques(get<_i16.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i52.GetTechniquesByCategory>(
      () => _i52.GetTechniquesByCategory(get<_i16.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i53.GetVisibleCategories>(
      () => _i53.GetVisibleCategories(get<_i10.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i54.GoogleAuthentication>(
      () => _i54.GoogleAuthentication(get<_i20.IUserRepository>()),
      registerFor: {_prod, _dev, _google_authentication_test_env});
  gh.factory<_i55.HiddenCategoriesBloc>(
      () => _i55.HiddenCategoriesBloc(get<_i49.GetHiddenCategories>()),
      registerFor: {_prod, _dev});
  ...
  gh.factory<_i57.TechniqueListBloc>(
      () => _i57.TechniqueListBloc(get<_i45.GetAllTechniques>()),
      registerFor: {_prod, _dev});
  gh.factory<_i58.TechniquesBloc>(
      () => _i58.TechniquesBloc(get<_i50.GetMostRecentTechniques>(),
          get<_i52.GetTechniquesByCategory>(), get<_i51.GetTechniques>()),
      registerFor: {_prod, _dev});
  gh.factory<_i59.ThirdPartyAuthBloc>(
      () => _i59.ThirdPartyAuthBloc(
          get<_i43.FacebookAuthentication>(),
          get<_i54.GoogleAuthentication>(),
          get<_i46.GetAuthProviders>(),
          get<_i23.LinkFacebookProvider>()),
      registerFor: {_prod, _dev});
  gh.factory<_i60.VisibleCategoriesBloc>(
      () => _i60.VisibleCategoriesBloc(get<_i53.GetVisibleCategories>()),
      registerFor: {_prod, _dev});
  ...
  gh.lazySingleton<_i62.CategoriesBloc>(
      () => _i62.CategoriesBloc(get<_i47.GetCategories>()),
      registerFor: {_prod, _dev});
  gh.factory<_i63.CategoryDetailBloc>(
      () => _i63.CategoryDetailBloc(get<_i52.GetTechniquesByCategory>()),
      registerFor: {_prod, _dev});
  gh.factoryParam<_i64.CategoryFormBloc, _i64.CategoryFormState?, dynamic>(
      ...
      registerFor: {_prod, _dev});
  gh.factory<_i65.EmailAuthBloc>(
      () => _i65.EmailAuthBloc(
          get<_i41.EmailAuthentication>(), get<_i3.ErrorBloc>()),
      registerFor: {_prod, _dev});
  gh.factory<_i66.EmailVerificationBloc>(
      () => _i66.EmailVerificationBloc(
          get<_i30.SignOut>(),
