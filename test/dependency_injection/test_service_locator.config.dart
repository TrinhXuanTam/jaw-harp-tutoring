...
_i1.GetIt testInitGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i19.SetLocale>(
      () => _i19.SetLocale(get<_i9.IUserFacade>(), get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i20.SignOut>(() => _i20.SignOut(get<_i9.IUserFacade>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i21.SignUp>(() => _i21.SignUp(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _sign_up_test_env});
  gh.factory<_i22.ThumbnailPickerBloc>(
      () => _i22.ThumbnailPickerBloc(get<_i17.PickImage>()),
      registerFor: {_prod, _dev});
  gh.factory<_i23.ToggleSwitchBloc>(() => _i23.ToggleSwitchBloc(),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i24.CreateCategory>(
      () => _i24.CreateCategory(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.factory<_i25.CreateCategoryBloc>(
      () => _i25.CreateCategoryBloc(get<_i24.CreateCategory>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i26.EmailAuthentication>(
      () => _i26.EmailAuthentication(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _email_authentication_test_env});
  gh.lazySingleton<_i27.EmailIsVerified>(
      () => _i27.EmailIsVerified(get<_i9.IUserFacade>()),
      registerFor: {_prod, _dev, _email_verification_check_test_env});
  gh.factory<_i28.EmailVerificationBloc>(
      () => _i28.EmailVerificationBloc(get<_i20.SignOut>(),
          get<_i18.SendEmailVerification>(), get<_i27.EmailIsVerified>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i29.FacebookAuthentication>(
      () => _i29.FacebookAuthentication(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _facebook_authentication_test_env});
  gh.lazySingleton<_i30.GetAuthProviders>(
      () => _i30.GetAuthProviders(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _get_authentication_providers_test_env});
  gh.lazySingleton<_i31.GetCurrentUser>(
      () => _i31.GetCurrentUser(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _get_current_user_test_env});
  gh.lazySingleton<_i32.GetHiddenCategories>(
      () => _i32.GetHiddenCategories(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i33.GetVisibleCategories>(
      () => _i33.GetVisibleCategories(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i34.GoogleAuthentication>(
      () => _i34.GoogleAuthentication(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _google_authentication_test_env});
  gh.factory<_i35.SignUpBloc>(
      () => _i35.SignUpBloc(get<_i21.SignUp>(), get<_i30.GetAuthProviders>(),
          get<_i13.LinkEmailProvider>()),
      registerFor: {_prod, _dev});
  gh.factory<_i36.ThirdPartyAuthBloc>(
      () => _i36.ThirdPartyAuthBloc(
          get<_i29.FacebookAuthentication>(),
          get<_i34.GoogleAuthentication>(),
          get<_i30.GetAuthProviders>(),
          get<_i14.LinkFacebookProvider>()),
      registerFor: {_prod, _dev});
  gh.factory<_i37.AdminMenuBloc>(
      () => _i37.AdminMenuBloc(
          get<_i33.GetVisibleCategories>(), get<_i32.GetHiddenCategories>()),
      registerFor: {_prod, _dev});
  gh.factory<_i38.AuthBloc>(
      () => _i38.AuthBloc(
          get<_i31.GetCurrentUser>(),
          get<_i27.EmailIsVerified>(),
          get<_i19.SetLocale>(),
          get<_i20.SignOut>()),
      registerFor: {_prod, _dev});
  gh.factory<_i39.EmailAuthBloc>(
      () => _i39.EmailAuthBloc(get<_i26.EmailAuthentication>()),
      registerFor: {_prod, _dev});
  return get;
}
