...
GetIt testInitGetIt(
  ...
  gh.lazySingleton<IAuthenticationLocalDataSource>(() => IAuthenticationLocalDataSourceMock(), registerFor: {_user_repository_test_env});
  gh.lazySingleton<IAuthenticationRemoteDataSource>(() => FirebaseAuthRemote(), registerFor: {_prod});
  gh.lazySingleton<IAuthenticationRemoteDataSource>(() => IAuthenticationRemoteDataSourceMock(), registerFor: {_user_repository_test_env});
  ...
  gh.lazySingleton<IUserRepository>(() => IUserRepositoryMock(), registerFor: {_email_authentication_test_env, _offline_authentication_test_env, _sign_up_test_env});
