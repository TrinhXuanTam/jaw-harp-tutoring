...
_i1.GetIt testInitGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i71.GetMostRecentTechniques>(
      ...
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i72.GetTechniqueById>(
      () => _i72.GetTechniqueById(get<_i55.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i73.GetTechniques>(
      () => _i73.GetTechniques(get<_i55.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i74.GetTechniquesByCategory>(
      () => _i74.GetTechniquesByCategory(get<_i55.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.factory<_i75.MostRecentTechniquesBloc>(
      () => _i75.MostRecentTechniquesBloc(get<_i71.GetMostRecentTechniques>()),
      registerFor: {_prod, _dev});
  gh.factory<_i76.SignUpBloc>(
      () => _i76.SignUpBloc(
          get<_i30.SignUp>(),
          get<_i46.GetAuthProviders>(),
          ...
          get<_i62.AuthBloc>()),
      registerFor: {_prod, _dev});
  gh.factory<_i77.TechniqueBloc>(
      () => _i77.TechniqueBloc(get<_i72.GetTechniqueById>()),
      registerFor: {_prod, _dev});
  gh.factory<_i78.TechniquesBloc>(
      () => _i78.TechniquesBloc(get<_i71.GetMostRecentTechniques>(),
          get<_i74.GetTechniquesByCategory>(), get<_i73.GetTechniques>()),
      registerFor: {_prod, _dev});
  gh.factory<_i79.CategoryDetailBloc>(
      () => _i79.CategoryDetailBloc(get<_i74.GetTechniquesByCategory>()),
      registerFor: {_prod, _dev});
  gh.singleton<_i80.TechniqueLocalStorageBloc>(
      _i80.TechniqueLocalStorageBloc(
