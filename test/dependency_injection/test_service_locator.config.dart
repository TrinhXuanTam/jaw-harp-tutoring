...
_i1.GetIt testInitGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i24.MarkTechniqueAsFavorite>(
      () => _i24.MarkTechniqueAsFavorite(get<_i20.IUserRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i25.PasswordReset>(
      () => _i25.PasswordReset(get<_i18.IUserFacade>()),
  ...
  gh.lazySingleton<_i28.PickVideo>(() => _i28.PickVideo(),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i29.RemoveTechniqueFromFavorites>(
      () => _i29.RemoveTechniqueFromFavorites(get<_i20.IUserRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i30.SendEmailVerification>(
      () => _i30.SendEmailVerification(get<_i18.IUserFacade>()),
  ...
  gh.lazySingleton<_i31.SetLocale>(
      ...
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i32.SignOut>(() => _i32.SignOut(get<_i18.IUserFacade>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i33.SignUp>(
      () => _i33.SignUp(get<_i16.IUserAuthRepository>()),
      registerFor: {_prod, _dev, _sign_up_test_env});
  gh.factory<_i34.TechniqueDetailBloc>(
      () => _i34.TechniqueDetailBloc(get<_i24.MarkTechniqueAsFavorite>(),
          get<_i29.RemoveTechniqueFromFavorites>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i35.TechniqueLocalDataSource>(
      () => _i35.TechniqueLocalDataSource(),
      registerFor: {_prod});
  gh.factory<_i36.ThumbnailPickerBloc>(
      () => _i36.ThumbnailPickerBloc(get<_i27.PickImage>()),
      registerFor: {_prod, _dev});
  gh.factory<_i37.ToggleSwitchBloc>(() => _i37.ToggleSwitchBloc(),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i38.UpdateCategory>(
      () => _i38.UpdateCategory(get<_i10.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i39.UpdateTechnique>(
      () => _i39.UpdateTechnique(get<_i14.ITechniqueAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.factory<_i40.UserSectionNavigationBloc>(
      () => _i40.UserSectionNavigationBloc(),
      registerFor: {_prod, _dev});
  gh.factory<_i41.VideoPickerBloc>(
      () => _i41.VideoPickerBloc(get<_i28.PickVideo>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i42.CreateCategory>(
      () => _i42.CreateCategory(get<_i10.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i43.CreateTechnique>(
      () => _i43.CreateTechnique(get<_i14.ITechniqueAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i44.EmailAuthentication>(
      () => _i44.EmailAuthentication(get<_i16.IUserAuthRepository>()),
      registerFor: {_prod, _dev, _email_authentication_test_env});
  gh.lazySingleton<_i45.EmailIsVerified>(
      () => _i45.EmailIsVerified(get<_i18.IUserFacade>()),
      registerFor: {_prod, _dev, _email_verification_check_test_env});
  gh.lazySingleton<_i46.FacebookAuthentication>(
      () => _i46.FacebookAuthentication(get<_i16.IUserAuthRepository>()),
      registerFor: {_prod, _dev, _facebook_authentication_test_env});
  gh.lazySingleton<_i47.GetAllCategories>(
      () => _i47.GetAllCategories(get<_i10.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i48.GetAllTechniques>(
      () => _i48.GetAllTechniques(get<_i14.ITechniqueAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i49.GetAuthProviders>(
      () => _i49.GetAuthProviders(get<_i16.IUserAuthRepository>()),
      registerFor: {_prod, _dev, _get_authentication_providers_test_env});
  gh.lazySingleton<_i50.GetCategories>(
      () => _i50.GetCategories(get<_i12.ICategoryRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i51.GetCategoryLocalizedData>(
      () => _i51.GetCategoryLocalizedData(get<_i10.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i52.GetCurrentUser>(
      () => _i52.GetCurrentUser(get<_i16.IUserAuthRepository>()),
      registerFor: {_prod, _dev, _get_current_user_test_env});
  gh.lazySingleton<_i53.GetHiddenCategories>(
      () => _i53.GetHiddenCategories(get<_i10.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i54.GetTechniqueLocalizedData>(
      () =>
          _i54.GetTechniqueLocalizedData(get<_i14.ITechniqueAdminRepository>()),
      registerFor: {_prod, _dev});
  ...
  gh.lazySingleton<_i56.GoogleAuthentication>(
      () => _i56.GoogleAuthentication(get<_i16.IUserAuthRepository>()),
  ...
  gh.lazySingleton<_i58.ITechniqueRepository>(
      () => _i59.TechniqueRepository(get<_i8.FirebaseUserSectionDataSource>(),
          get<_i35.TechniqueLocalDataSource>()),
      registerFor: {_prod});
  gh.factoryParam<_i60.TechniqueFormBloc, _i60.TechniqueFormState?, dynamic>(
      (initialState, _) => _i60.TechniqueFormBloc(
          initialState,
          get<_i47.GetAllCategories>(),
          get<_i43.CreateTechnique>(),
          get<_i39.UpdateTechnique>(),
          get<_i4.ErrorBloc>()),
      registerFor: {_prod, _dev});
  gh.factory<_i61.TechniqueListBloc>(
      () => _i61.TechniqueListBloc(get<_i48.GetAllTechniques>()),
      registerFor: {_prod, _dev});
  gh.factory<_i62.TechniqueLocalizationBloc>(
      () =>
          _i62.TechniqueLocalizationBloc(get<_i54.GetTechniqueLocalizedData>()),
      registerFor: {_prod, _dev});
  gh.factory<_i63.ThirdPartyAuthBloc>(
      () => _i63.ThirdPartyAuthBloc(
          get<_i46.FacebookAuthentication>(),
          get<_i56.GoogleAuthentication>(),
          get<_i49.GetAuthProviders>(),
          get<_i23.LinkFacebookProvider>()),
      registerFor: {_prod, _dev});
  gh.factory<_i64.VisibleCategoriesBloc>(
      () => _i64.VisibleCategoriesBloc(get<_i55.GetVisibleCategories>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i65.AuthBloc>(
      () => _i65.AuthBloc(
          get<_i52.GetCurrentUser>(),
          get<_i45.EmailIsVerified>(),
          get<_i31.SetLocale>(),
          get<_i32.SignOut>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i66.CategoriesBloc>(
      () => _i66.CategoriesBloc(get<_i50.GetCategories>()),
      registerFor: {_prod, _dev});
  gh.factoryParam<_i67.CategoryFormBloc, _i67.CategoryFormState?, dynamic>(
      (initialState, _) => _i67.CategoryFormBloc(
          initialState, get<_i42.CreateCategory>(), get<_i38.UpdateCategory>()),
      registerFor: {_prod, _dev});
  gh.factory<_i68.CategoryLocalizationBloc>(
      () => _i68.CategoryLocalizationBloc(get<_i51.GetCategoryLocalizedData>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i69.DeleteDownloadedTechnique>(
      () => _i69.DeleteDownloadedTechnique(get<_i58.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i70.DownloadTechnique>(
      () => _i70.DownloadTechnique(get<_i58.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.factory<_i71.EmailAuthBloc>(
      () => _i71.EmailAuthBloc(
          get<_i44.EmailAuthentication>(), get<_i4.ErrorBloc>()),
      registerFor: {_prod, _dev});
  gh.factory<_i72.EmailVerificationBloc>(
      () => _i72.EmailVerificationBloc(
          get<_i32.SignOut>(),
          ...
          get<_i65.AuthBloc>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i73.GetDownloadedTechniques>(
      () => _i73.GetDownloadedTechniques(get<_i58.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i74.GetMostRecentTechniques>(
      () => _i74.GetMostRecentTechniques(get<_i58.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i75.GetTechniqueById>(
      () => _i75.GetTechniqueById(get<_i58.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i76.GetTechniques>(
      () => _i76.GetTechniques(get<_i58.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i77.GetTechniquesByCategory>(
      () => _i77.GetTechniquesByCategory(get<_i58.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.factory<_i78.MostRecentTechniquesBloc>(
      () => _i78.MostRecentTechniquesBloc(get<_i74.GetMostRecentTechniques>()),
      registerFor: {_prod, _dev});
  gh.factory<_i79.SignUpBloc>(
      () => _i79.SignUpBloc(
          get<_i33.SignUp>(),
          get<_i49.GetAuthProviders>(),
