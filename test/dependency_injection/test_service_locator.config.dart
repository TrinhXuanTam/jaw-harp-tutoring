...
_i1.GetIt testInitGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i52.AuthBloc>(
      () => _i52.AuthBloc(
          ...
          get<_i27.SignOut>()),
      registerFor: {_prod, _dev});
  gh.factory<_i53.CategoriesBloc>(
      () => _i53.CategoriesBloc(get<_i45.GetVisibleCategories>()),
      registerFor: {_prod, _dev});
  gh.factory<_i54.CategoryDetailBloc>(
      () => _i54.CategoryDetailBloc(get<_i44.GetTechniquesByCategory>()),
      registerFor: {_prod, _dev});
  gh.factoryParam<_i55.CategoryFormBloc, _i55.CategoryFormState?, dynamic>(
      (initialState, _) => _i55.CategoryFormBloc(
          initialState, get<_i34.CreateCategory>(), get<_i31.UpdateCategory>()),
      registerFor: {_prod, _dev});
  gh.factory<_i56.EmailAuthBloc>(
      () => _i56.EmailAuthBloc(
          get<_i36.EmailAuthentication>(), get<_i3.ErrorBloc>()),
      registerFor: {_prod, _dev});
  gh.factory<_i57.EmailVerificationBloc>(
      () => _i57.EmailVerificationBloc(
          get<_i27.SignOut>(),
