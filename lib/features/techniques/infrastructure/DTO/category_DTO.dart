...
class CategoryDTO extends Category {
  ...
  CategoryDTO(String id, bool isVisible, this.localizedData) : super(id, isVisible, localizedData);
  ...
  factory CategoryDTO.fromFirestore(DocumentSnapshot documentSnapshot) {
    ...
    return CategoryDTO(documentSnapshot.id, documentSnapshot["isVisible"], localizedData);
  }
}
