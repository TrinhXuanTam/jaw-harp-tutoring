...
_i1.GetIt initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i18.SetLocale>(
      () => _i18.SetLocale(get<_i8.IUserFacade>(), get<_i10.IUserRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i19.SignOut>(() => _i19.SignOut(get<_i8.IUserFacade>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i20.SignUp>(() => _i20.SignUp(get<_i10.IUserRepository>()),
      registerFor: {_prod, _dev, _sign_up_test_env});
  gh.factory<_i21.ThumbnailPickerBloc>(
      () => _i21.ThumbnailPickerBloc(get<_i16.PickImage>()),
      registerFor: {_prod, _dev});
  gh.factory<_i22.ToggleSwitchBloc>(() => _i22.ToggleSwitchBloc(),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i23.CreateCategory>(
      () => _i23.CreateCategory(get<_i6.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.factory<_i24.CreateCategoryBloc>(
      () => _i24.CreateCategoryBloc(get<_i23.CreateCategory>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i25.EmailAuthentication>(
      () => _i25.EmailAuthentication(get<_i10.IUserRepository>()),
      registerFor: {_prod, _dev, _email_authentication_test_env});
  gh.lazySingleton<_i26.EmailIsVerified>(
      () => _i26.EmailIsVerified(get<_i8.IUserFacade>()),
      registerFor: {_prod, _dev, _email_verification_check_test_env});
  gh.factory<_i27.EmailVerificationBloc>(
      () => _i27.EmailVerificationBloc(get<_i19.SignOut>(),
          get<_i17.SendEmailVerification>(), get<_i26.EmailIsVerified>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i28.FacebookAuthentication>(
      () => _i28.FacebookAuthentication(get<_i10.IUserRepository>()),
      registerFor: {_prod, _dev, _facebook_authentication_test_env});
  gh.lazySingleton<_i29.GetAuthProviders>(
      () => _i29.GetAuthProviders(get<_i10.IUserRepository>()),
      registerFor: {_prod, _dev, _get_authentication_providers_test_env});
  gh.lazySingleton<_i30.GetCurrentUser>(
      () => _i30.GetCurrentUser(get<_i10.IUserRepository>()),
      registerFor: {_prod, _dev, _get_current_user_test_env});
  gh.lazySingleton<_i31.GetHiddenCategories>(
      () => _i31.GetHiddenCategories(get<_i6.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i32.GetVisibleCategories>(
      () => _i32.GetVisibleCategories(get<_i6.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i33.GoogleAuthentication>(
      () => _i33.GoogleAuthentication(get<_i10.IUserRepository>()),
      registerFor: {_prod, _dev, _google_authentication_test_env});
  gh.factory<_i34.SignUpBloc>(
      () => _i34.SignUpBloc(get<_i20.SignUp>(), get<_i29.GetAuthProviders>(),
          get<_i12.LinkEmailProvider>()),
      registerFor: {_prod, _dev});
  gh.factory<_i35.ThirdPartyAuthBloc>(
      () => _i35.ThirdPartyAuthBloc(
          get<_i28.FacebookAuthentication>(),
          get<_i33.GoogleAuthentication>(),
          get<_i29.GetAuthProviders>(),
          get<_i13.LinkFacebookProvider>()),
      registerFor: {_prod, _dev});
  gh.factory<_i36.AdminMenuBloc>(
      () => _i36.AdminMenuBloc(
          get<_i32.GetVisibleCategories>(), get<_i31.GetHiddenCategories>()),
      registerFor: {_prod, _dev});
  gh.factory<_i37.AuthBloc>(
      () => _i37.AuthBloc(
          get<_i30.GetCurrentUser>(),
          get<_i26.EmailIsVerified>(),
          get<_i18.SetLocale>(),
          get<_i19.SignOut>()),
      registerFor: {_prod, _dev});
  gh.factory<_i38.EmailAuthBloc>(
      () => _i38.EmailAuthBloc(get<_i25.EmailAuthentication>()),
      registerFor: {_prod, _dev});
  return get;
}
