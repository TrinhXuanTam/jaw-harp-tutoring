...
_i1.GetIt initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i7.ICategoryAdminRepository>(
      () => _i8.CategoryAdminRepository(get<_i4.FirebaseAdminDataSource>()),
      registerFor: {_prod});
  gh.lazySingleton<_i9.IUserFacade>(() => _i10.FirebaseAuthFacade(),
      registerFor: {_prod});
  gh.lazySingleton<_i11.IUserRepository>(
      () => _i12.UserRepository(get<_i5.FirebaseAuthDataSource>()),
  ...
  gh.factory<_i16.PasswordResetBloc>(
      () => _i16.PasswordResetBloc(
          get<_i15.PasswordReset>(), get<_i3.ErrorBloc>()),
      registerFor: {_prod, _dev});
  ...
  gh.factory<_i24.ToggleSwitchBloc>(() => _i24.ToggleSwitchBloc(),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i25.UpdateCategory>(
      () => _i25.UpdateCategory(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i26.UpdateTechnique>(
      () => _i26.UpdateTechnique(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.factory<_i27.VideoPickerBloc>(
      () => _i27.VideoPickerBloc(get<_i18.PickVideo>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i28.CreateCategory>(
      () => _i28.CreateCategory(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i29.CreateTechnique>(
      () => _i29.CreateTechnique(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i30.EmailAuthentication>(
      () => _i30.EmailAuthentication(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _email_authentication_test_env});
  gh.lazySingleton<_i31.EmailIsVerified>(
      () => _i31.EmailIsVerified(get<_i9.IUserFacade>()),
      registerFor: {_prod, _dev, _email_verification_check_test_env});
  gh.lazySingleton<_i32.FacebookAuthentication>(
      () => _i32.FacebookAuthentication(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _facebook_authentication_test_env});
  gh.lazySingleton<_i33.GetAllCategories>(
      () => _i33.GetAllCategories(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i34.GetAllTechniques>(
      () => _i34.GetAllTechniques(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i35.GetAuthProviders>(
      () => _i35.GetAuthProviders(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _get_authentication_providers_test_env});
  gh.lazySingleton<_i36.GetCurrentUser>(
      () => _i36.GetCurrentUser(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _get_current_user_test_env});
  gh.lazySingleton<_i37.GetHiddenCategories>(
      () => _i37.GetHiddenCategories(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i38.GetTechniquesByCategory>(
      () => _i38.GetTechniquesByCategory(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i39.GetVisibleCategories>(
      () => _i39.GetVisibleCategories(get<_i7.ICategoryAdminRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i40.GoogleAuthentication>(
      () => _i40.GoogleAuthentication(get<_i11.IUserRepository>()),
      registerFor: {_prod, _dev, _google_authentication_test_env});
  gh.factory<_i41.HiddenCategoriesBloc>(
      () => _i41.HiddenCategoriesBloc(get<_i37.GetHiddenCategories>()),
      registerFor: {_prod, _dev});
  gh.factoryParam<_i42.TechniqueFormBloc, _i42.TechniqueFormState?, dynamic>(
      (initialState, _) => _i42.TechniqueFormBloc(
          initialState,
          get<_i33.GetAllCategories>(),
          get<_i29.CreateTechnique>(),
          get<_i26.UpdateTechnique>(),
          get<_i3.ErrorBloc>()),
      registerFor: {_prod, _dev});
  gh.factory<_i43.TechniqueListBloc>(
      () => _i43.TechniqueListBloc(get<_i34.GetAllTechniques>()),
      registerFor: {_prod, _dev});
  gh.factory<_i44.ThirdPartyAuthBloc>(
      () => _i44.ThirdPartyAuthBloc(
          get<_i32.FacebookAuthentication>(),
          get<_i40.GoogleAuthentication>(),
          get<_i35.GetAuthProviders>(),
          get<_i14.LinkFacebookProvider>()),
      registerFor: {_prod, _dev});
  gh.factory<_i45.VisibleCategoriesBloc>(
      () => _i45.VisibleCategoriesBloc(get<_i39.GetVisibleCategories>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i46.AuthBloc>(
      () => _i46.AuthBloc(
          ...
          get<_i21.SignOut>()),
      registerFor: {_prod, _dev});
  gh.factory<_i47.CategoryDetailBloc>(
      () => _i47.CategoryDetailBloc(get<_i38.GetTechniquesByCategory>()),
      registerFor: {_prod, _dev});
  gh.factoryParam<_i48.CategoryFormBloc, _i48.CategoryFormState?, dynamic>(
      (initialState, _) => _i48.CategoryFormBloc(
          initialState, get<_i28.CreateCategory>(), get<_i25.UpdateCategory>()),
      registerFor: {_prod, _dev});
  gh.factory<_i49.EmailAuthBloc>(
      () => _i49.EmailAuthBloc(
          get<_i30.EmailAuthentication>(), get<_i3.ErrorBloc>()),
      registerFor: {_prod, _dev});
  gh.factory<_i50.EmailVerificationBloc>(
      () => _i50.EmailVerificationBloc(
          get<_i21.SignOut>(),
          get<_i19.SendEmailVerification>(),
          get<_i31.EmailIsVerified>(),
          get<_i3.ErrorBloc>(),
          get<_i46.AuthBloc>()),
      registerFor: {_prod, _dev});
