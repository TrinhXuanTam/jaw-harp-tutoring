...
_i1.GetIt initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i66.EmailVerificationBloc>(
      () => _i66.EmailVerificationBloc(
          ...
          get<_i61.AuthBloc>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i67.GetMostRecentTechniques>(
      () => _i67.GetMostRecentTechniques(get<_i54.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i68.GetTechniques>(
      () => _i68.GetTechniques(get<_i54.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.lazySingleton<_i69.GetTechniquesByCategory>(
      () => _i69.GetTechniquesByCategory(get<_i54.ITechniqueRepository>()),
      registerFor: {_prod, _dev});
  gh.factory<_i70.SignUpBloc>(
      () => _i70.SignUpBloc(
          ...
          get<_i61.AuthBloc>()),
      registerFor: {_prod, _dev});
  gh.factory<_i71.TechniquesBloc>(
      () => _i71.TechniquesBloc(get<_i67.GetMostRecentTechniques>(),
          get<_i69.GetTechniquesByCategory>(), get<_i68.GetTechniques>()),
      registerFor: {_prod, _dev});
  gh.factory<_i72.CategoryDetailBloc>(
      () => _i72.CategoryDetailBloc(get<_i69.GetTechniquesByCategory>()),
      registerFor: {_prod, _dev});
  return get;
}
